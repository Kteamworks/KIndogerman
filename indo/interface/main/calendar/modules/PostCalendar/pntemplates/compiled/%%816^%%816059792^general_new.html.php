<?php /* Smarty version 2.6.2, created on 2018-04-04 16:39:13
         compiled from C:%5Cxampp%5Chtdocs%5Cdemo_test%5Cinterface%5Cforms%5Cvitals/templates/vitals/general_new.html */ ?>
...
?>
	...
	<?php if ($this->_tpl_vars['units_of_measurement'] == 4): ?><tr class="hide"><?php else: ?><tr><?php endif; ?>
		...
		<?php if ($this->_tpl_vars['units_of_measurement'] == 2): ?><td class="valuesunfocus"><?php else: ?><td class='currentvalues'><?php endif; ?>
                <input type="number" min="0" max="11" step=".01" autocomplete='off' name='height' id='height_input' value="<?php if ($this->_tpl_vars['vitals']->get_height() != 0):  echo $this->_tpl_vars['vitals']->get_height();  endif; ?>" onChange="convIntoCm('height_input');"/>
                </td>
	<?php if (count($_from = (array)$this->_tpl_vars['results'])):
    foreach ($_from as $this->_tpl_vars['result']):
?>
