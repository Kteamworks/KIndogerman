<?php /* Smarty version 2.6.2, created on 2018-03-21 15:03:07
         compiled from C:/xampp/htdocs/demo_test/templates/prescription/general_list.html */ ?>
<?php require_once(SMARTY_DIR . 'core' . DIRECTORY_SEPARATOR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'xl', 'C:/xampp/htdocs/demo_test/templates/prescription/general_list.html', 92, false),)), $this); ?>
<html>
<head>
        ...
        <tr>
            <td align="left">
                <table>
                    <tr>
                        <td>
                            <a id="multiprint" style="display:none;" href="<?php echo $this->_tpl_vars['CONTROLLER']; ?>
...
.</th>
        ...
        <th><?php echo smarty_function_xl(array('t' => 'Quantity'), $this);?>
</th>
...
">
	<?php if ($this->_tpl_vars['prescription']->active > 0): ?><b><?php endif;  echo $this->_tpl_vars['prescription']->drug;  echo $this->_tpl_vars['prescription']->dosage; ?>
 <?php echo $this->_tpl_vars['prescription']->get_unit_display();  if ($this->_tpl_vars['prescription']->active > 0): ?></b><?php endif; ?>&nbsp;
    </td>
	<?php endif; ?>
    <td id="<?php echo $this->_tpl_vars['prescription']->id; ?>
">
...
&nbsp;
	...
	<td id="<?php echo $this->_tpl_vars['prescription']->id; ?>
">
       <?php echo $this->_tpl_vars['prescription']->get_days(); ?>
 &nbsp;
    </td>
    <td id="<?php echo $this->_tpl_vars['prescription']->id; ?>
">
